...
export default function HomePage() {
  ...
  // 🔥 LOGIN — movido para cima (correção do erro)
  ...
  useEffect(() => {
    ...
    const frases = [
      ...
      "A Análise Completa já será entregue…"
    ];
  ...
  async function carregarDadosUsuario(u) {
    ...
    // Captura o indicador da URL ou localStorage
    let indicadorURL = capturarIndicadorURL();
    if (!indicadorURL) {
      indicadorURL = localStorage.getItem("indicador");
    }
    ...
    // Se veio indicador e o user ainda não tem → salva
    ...
    return (
      <div style={modalBackdropStyle}>
        <div style={modalContentStyle}>
          ...
          <button
            onClick={() => setShowIndiqueModal(false)}
    ...
    >
      ...
      >
        ...
        <span style={{ color: "#22c55e" }}>
          BetGram -
          <span style={{ color: "#fff" }}> Analisador Esportivo</span>
        </span>
      </h2>
          ...
          !panelFlip ? (
            <>
              ...
              >
                ...
                <option value="hoquei">🏒 Hóquei</option>
                <option value="corrida">🏎️ Corridas</option>
