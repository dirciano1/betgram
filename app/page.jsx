...
export default function HomePage() {
  ...
  useEffect(() => {
  function estilizarAnalise() {
    // Selecionar TODOS os blocos pelo estilo padrão da sua caixa de análise
    ...
    blocos.forEach(bloco => {
      ...
      // ======== ESTILIZA LINHAS QUE COMEÇAM COM 🏟️ EM VERDE ========
  ...
  // E executa de novo sempre que o DOM mudar (quando chega nova análise)
  const obs = new MutationObserver(estilizarAnalise);
