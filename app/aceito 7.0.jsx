...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      >
        {/* === Cabeçalho com nome abreviado e créditos minimalistas === */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
          ...
          <div style={{ animation: "fadeIn 0.4s ease" }}>
            ...
            <div style={{ textAlign: "center", marginTop: "40px" }}>
              <p style={{ color: "#ccc", marginBottom: "20px" }}>
                Para adicionar créditos, entre em contato pelo WhatsApp e
              ...
              >
                Em breve: integração automática com{" "}
                <b>Abacate Pay 🍈</b> para recarga instantânea via Pix!
              </p>
            </div>
          </div>
        )}
